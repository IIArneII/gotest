...
//go:generate swagger generate server --target ../../restapi --name TestServer --spec ../../../../swagger.yaml --principal interface{} --exclude-main
...
func configureAPI(api *operations.TestServerAPI) http.Handler {
	...
	if api.CreateAPIKeyHandler == nil {
		api.CreateAPIKeyHandler = operations.CreateAPIKeyHandlerFunc(func(params operations.CreateAPIKeyParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.CreateAPIKey has not yet been implemented")
		})
	}
